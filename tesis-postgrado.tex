...
\keywords{Stream Processing System; Elasticidad; Replicación; Algoritmo predictivo; Algoritmo reactivo}
...
\include{chapters/2-estado_del_arte}
%\include{chapters/3-disegno_del_framework}
%\include{chapters/4-aplicaciones_de_ejemplo}
%\include{chapters/5-evaluacion_del_framework}
