...
Dentro de los sistemas que se basan en el modelo de productor y consumidor, puede tratarse como un modelo matemática basado en las líneas de espera en el sistema, el estudio de esto se denomina teoría de colas \citep{queueingtheory}.

La teoría de colas se centra en el estudio de las colas que existen en un sistema cuyo esquema existe un productor y un consumidor (servidor), como se muestra en la Figura \ref{fig:teoriaColas}. De esta manera, se encuentran tres entes importantes: el productor, la cola y el servidor.
